    ...
    <>
        ...
        <div className="container py-5">
            <div className="row g-5">
                ...
                <div className="col-lg-3 col-md-6">
                    <h5 className="text-white mb-4">Newsletter & Broucher</h5>

                 
                     
                    <div className="position-relative w-100 p-s2 pb-2">
                    <DownloadButton url="/1.pdf" filename="Broucher-Spin_industries.pdf" />
                    </div>
